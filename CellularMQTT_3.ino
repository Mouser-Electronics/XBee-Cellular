...
*/
   ...
   //AltSoftSerial monitorSerial;
    ...
    char ubidotstoken[] = "HpmUoreWuuX8igkKwhqzDIWjvY6vWo"; //your token here
    char idlight[] = "5967d07976254215a41cb823"; // Ambient Light Sensor ID
    char idUV[] = "5967dbbf7625425598ac630e"; // UV Sensor ID
    char idTemp[] = "5967e3277625426c20338030"; // Temp sensor ID
    char idHumi[] = "5967e3307625426c2448e92a"; // Humidity sensor ID
    char idRelay [] = "5968bbb3762542643fef5092"; // Relay ID
